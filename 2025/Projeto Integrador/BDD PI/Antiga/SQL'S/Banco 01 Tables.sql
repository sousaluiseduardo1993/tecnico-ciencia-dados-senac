...
CREATE TABLE IF NOT EXISTS Ingredientes (
    ...
    tipo VARCHAR(50),
    origem VARCHAR(50) NULL, -- 'vegetal','animal','misto','fungo', etc.
...
-- H) RH (Cargos, Funcionários, Turnos)
...
-- F) PEDIDOS E PAGAMENTOS (depois de Funcionarios, Clientes, Plataformas, Mesas)
CREATE TABLE IF NOT EXISTS Pedidos (
    ...
    id_mesa INT NULL,
    id_funcionario_atendente INT NULL,
    FOREIGN KEY (id_cliente) REFERENCES Clientes(id_cliente)
...
CREATE TABLE IF NOT EXISTS ItensPedido (
    ...
    id_funcionario_preparo INT NULL,
...
-- G) APOIO: Fornecedores, Movimentos de Estoque, Custo Histórico
...
-- Extras (Dietas, Certificações, Zonas)
...
CREATE TABLE IF NOT EXISTS PratoDieta (
    ...
    FOREIGN KEY (id_prato) REFERENCES Pratos(id_prato) ON DELETE CASCADE ON UPDATE CASCADE,
...
CREATE TABLE IF NOT EXISTS IngredienteZona (
    ...
    FOREIGN KEY (id_zona) REFERENCES ZonasCozinha(id_zona) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;