...
--
-- Table structure for table `audit_movimentoestoque`
--

DROP TABLE IF EXISTS `audit_movimentoestoque`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `audit_movimentoestoque` (
  `id_audit_mov` bigint NOT NULL AUTO_INCREMENT,
  ...
  PRIMARY KEY (`id_audit_mov`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `audit_movimentoestoque`
--

LOCK TABLES `audit_movimentoestoque` WRITE;
/*!40000 ALTER TABLE `audit_movimentoestoque` DISABLE KEYS */;
/*!40000 ALTER TABLE `audit_movimentoestoque` ENABLE KEYS */;
UNLOCK TABLES;
