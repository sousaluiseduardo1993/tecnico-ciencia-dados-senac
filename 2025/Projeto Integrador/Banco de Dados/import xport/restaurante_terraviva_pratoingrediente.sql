...
CREATE TABLE `pratoingrediente` (
  ...
  KEY `idx_pratoingrediente_prato` (`id_prato`),
...
INSERT INTO `pratoingrediente` VALUES (3,5,0.180),(3,24,0.080),(3,34,0.180),(4,33,0.300),(5,1,0.250),(5,2,0.150),(5,3,0.200),(5,4,0.020),(5,5,0.180),(5,6,0.150);
